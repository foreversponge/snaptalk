  ...
  handleComment = () => {
    CommentController.shared
      ...
      .then(ref => {
        ...
        CommentController.shared.updateCommentList({
          commentId: ref.id,
  ...
  getData = () => {
    ...
    this.unsubscribe = CommentController.shared.firestore
      ...
      .finally(() => {
        ...
        this.setState({
          commentList: this.state.commentList.sort(
    ...
    const buttons = [
      {text: 'Cancel', type: 'cancel'},
      {
        ...
        onPress: () => {
          ...
          CommentController.shared.deleteComment(
            comment.commentKey,
            comment.postKey,
          );
          ...
          <TouchableHighlight
            onPress={() => {
              if (CommentController.shared.uid == item.uid) {
                ...
                Alert.alert(
                  this.state.defaultErrorMessageHeader,
                  'You cannot edit a comment that you have not posted.',
                );
              }
            }}>
          ...
          <TouchableHighlight
            onPress={() => {
              if (CommentController.shared.uid == item.uid) {
                ...
                Alert.alert(
                  this.state.defaultErrorMessageHeader,
                  'You cannot delete a comment that you have not posted.',
                );
              }
            }}>
      ...
      <View>
        <Modal
            ...
            <View>
              <TouchableHighlight
                ...
                <Icon
                  ...
                  size={40}
                  style={styles.commentExitButton}
                />
              </TouchableHighlight>
            </View>
            <FlatList
          ...
          <View style={styles.addCommentContainer}>
            ...
            />
            <TouchableHighlight onPress={this.handleComment}>
              <View>
                <Icon
          ...
          <View style={styles.popover}>
            <Popover
              ...
              <Text style={styles.editTitle}>
                Please enter the new comment below
              </Text>
              <View style={styles.popoverButtons}>
                ...
                <TouchableHighlight
                  onPress={() => {
                    ...
                    CommentController.shared.modifyComment(
                      this.state.commentState.commentKey,
