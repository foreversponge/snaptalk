...
import { Modal, Text, TouchableHighlight, View, ScrollView, TextInput, FlatList, Image } from 'react-native';
    ...
    getData = () => {
        ...
        this.unsubscribe = Fire.shared.firestore
            ...
            .then(snapshot => {
                ...
                this.setState({ comments: this.state.comments.sort((a, b) => a.timestamp - b.timestamp) })
            })
    }
                    ...
                    <View style={{ flex: 1 }}>
                        <View>
                            <TouchableHighlight
                                ...
                                <Icon name="ios-close" size={50} color="#73788B" style={{ marginRight: 50 }} />
                            </TouchableHighlight>
                        </View>
                        ...
                        <View style={{
                            ...
                            <Button style={{ marginRight: 10 }} title="add comment" onPress={this.handleComment}>
